...
const PatientSidebar = () => {
  ...
  return (
    <div className={`bg-blue-800 text-white transition-all duration-300 ease-in-out ${isCollapsed ? 'w-16' : 'w-64'} min-h-screen relative flex flex-col`}>
      <div className="p-4">
      ...
      <div className="mt-auto p-4">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isCollapsed ? '' : 'mr-2'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
